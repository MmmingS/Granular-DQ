...
parser.add_argument('--conv_idx', type=str, default='22',
                    help='vgg index')
parser.add_argument('--target_bit', type=int, default=6,
                    help='target bit')
parser.add_argument('--alpha',type=float,default=0.05,
                    help='for bit regulation')                   
...
parser.add_argument('--step_size', type=int, default=90, help='step size for combining patches')
